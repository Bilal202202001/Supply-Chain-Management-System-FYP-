        ...
        {isOpen && (
            <div className="w-full mb-5 flex flex-col items-center">
                ...
                <table class="table-fixed font-lexend border-separate shadow-lg shadow-slate-700 p-5 rounded-xl w-4/5 m-5 text-center">
                    ...
                    <tbody>
                        {data && data.map((seller, idx) => {

                            return <>
                                <tr>
                                    <td className='p-2'>{seller.name}</td>
                                    <td className='p-2'>{seller.type}</td>
                                    <td className='p-2 text-ellipsis overflow-hidden'>{seller.Email}</td>
                                    <td className='p-2 text-ellipsis overflow-hidden'>{seller.phoneNo}</td>
                                    <td className='p-2 text-ellipsis overflow-hidden'>{seller.ibn}</td>
                                    <td className='p-2 '>{seller.productCat}</td>
                                    ...
                                    <td className='p-2 text text-gradient-to-t text-slate-950 hover:text-red-700 cursor-pointer' onClick={() => handleDelete(seller.id)}>
                                        <div className='w-full flex items-center justify-center'>
