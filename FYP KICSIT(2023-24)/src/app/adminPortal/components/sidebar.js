            ...
            <div className='py-2 w-full '>
                <ul>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        ...
                        <Link href="/adminPortal/Dashboard" className='text-sm font-lexend'> Dashboard </Link>
                    </li>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                    ...
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        ...
                        <Link href="/adminPortal/products" className='text-sm font-lexend'> Products </Link>
                    </li> */}
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                    ...
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        ...
                        <Link href="/adminPortal/Sellers" className='text-sm font-lexend'> Sellers </Link>
                    </li>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilUserCircle width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Suppliers" className='text-sm font-lexend'> Supplier </Link>
                    </li>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilUserSquare width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Employees" className='text-sm font-lexend'> Employees </Link>
                    </li>
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilTransaction width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Orders" className='text-sm font-lexend'> Orders </Link>
                    </li> */}
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilHistory width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Sales" className='text-sm font-lexend'> Sales </Link>
                    </li> */}
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilArrowGrowth width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Charts" className='text-sm font-lexend'> Charts </Link>
                    </li> */}
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilArrowGrowth width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Shipments" className='text-sm font-lexend'> Shipments </Link>
                    </li> */}
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilEnvelopeQuestion width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Messeges" className='text-sm font-lexend'> Messeges </Link>
                    </li>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilBookReader width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/Reviews" className='text-sm font-lexend'> Reviews </Link>
                    </li>
                    {/* <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
                        <Unicons.UilMoneyStack width={20} className="mx-5 text-gray-600" />
                        <Link href="/adminPortal/UiElements" className='text-sm font-lexend'> UI Elements </Link>
                    </li> */}
                    <div className='flex flex-col'>
                        <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer' >
                            <Unicons.UilMoneyStack width={20} className="mx-5 text-gray-600" />
                            <span className='text-sm font-lexend cursor-pointer'>
                            <Link href="/adminPortal/UiElements" className='text-sm font-lexend'> UI Elements 
                            </Link>
                            </span>
                        ...
                        {expanded && (
                            <ul className='my-3 space-y-1 flex flex-col items-center w-full'>
                                <li><Link href="/adminPortal/UiElements/products" className='flex justify-center items-center font-lexend text-sm p-1 hover:bg-slate-800 rounded-lg w-20 bg-slate-900'>Product</Link></li>
                                <li><Link href="/adminPortal/UiElements/Categories" className='flex justify-center items-center font-lexend text-sm p-1 hover:bg-slate-800 rounded-lg w-20 bg-slate-900'>Category</Link></li>
                                <li><Link href="/adminPortal/UiElements/Services" className='flex justify-center items-center font-lexend text-sm p-1 hover:bg-slate-800 rounded-lg w-20 bg-slate-900'>Services</Link></li>
                                <li><Link href="/adminPortal/UiElements/Team" className='flex justify-center items-center font-lexend text-sm p-1 hover:bg-slate-800 rounded-lg w-20 bg-slate-900'>Team</Link></li>
                            </ul>
                        )}
                    </div>
                    <li className='flex items-center h-10 hover:bg-slate-900 cursor-pointer'>
