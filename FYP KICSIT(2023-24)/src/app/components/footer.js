                        ...
                        <div className="col-span-12">
                            <div className="py-[60px] px-0">
                                <div className="grid grid-cols-1">
                                    ...
                                    <img src='/images/logoC.png' className='h-16 w-16 mx-auto block' alt="logo"/>
                                        {/* <Image src="/images/logo-icon-64.png" className="block mx-auto" alt="" width={64} height={64} /> */}
                                        <p className="max-w-xl mx-auto text-slate-400 mt-8">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt amet facere mollitia a beatae, deleniti commodi dolorum sapiente voluptatum at aperiam iste dolore nemo?
                                        </p>
                                    </div>
                            ...
                            <div className="md:col-span-6">
                                <div className="md:text-start text-center">
                                    <p className="text-gray-400">©
                                        {new Date().getFullYear()} NexusNest.com, Inc. All Right Reserved
                                    </p>
                                </div>
                            </div>
