            ...
            <nav className={`${navbarTop === true ? 'is-sticky' : ''} navbar font-lexend `} id="navbar">
                <div className="container flex flex-wrap items-center justify-end">
                    <a className="navbar-brand md:me-8" href="/">
                        ...
                        <h2 className=' text-lg font-lexend text-black ml-3 dark:text-white hover:text-violet-600 l-dark'>NexusNest</h2>
                        <h2 className=' text-lg font-lexend text-gray-400 ml-3 dark:text-white hover:text-violet-600 l-light'>NexusNest</h2>
                    ...
                    <div className={`${isOpen === true ? 'navigation lg_992:order-1 lg_992:flex hidden ms-auto' : 'navigation lg_992:order-1 lg_992:flex block ms-auto'}`} id="menu-collapse">
                        <ul className="navbar-nav" id="navbar-navlist">
                            <li className={`nav-item`}>
                                <Link1 href="/home" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Home</Link1>
                            </li>
                            <li className={`nav-item`}>
                                <Link1 href="/features" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Services</Link1>
                            </li>
                            <li className={`nav-item`}>
                                <Link1 href="/pricing" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Pricing</Link1>
                            </li>
                            <li className={`nav-item`}>
                                <Link1 href="/testi" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Review</Link1>
                            </li>
                            <li className={`nav-item`}>
                                <Link1 href="/blog" spy={true} smooth={true} duration={500} className="nav-link">Blog</Link1>
                            </li>
                            <li className={`nav-item`}>
                                <Link1 href="/contact" activeClass="active" spy={true} smooth={true} duration={500} className="nav-link">Contact us</Link1>
                            </li>
                        </ul>
                    </div>
                </div>
