        ...
        <>
            <nav className={`${navbarTop === true ? 'is-sticky' : ''} navbar font-lexend `} id="navbar">
                ...
                <a className="navbar-brand md:me-8" href="/">
                        ...
                        {/* In the Pages except Home */}
                        <img src='/images/logoC.png' className='h-10 w-10' alt="logo"/>
                        <h2 className=' text-lg font-lexend  ml-3 dark:text-gray-400 hover:text-violet-600 l-dark'>NexusNest</h2>
                        <h2 className=' text-lg font-lexend text-gray-400 ml-3 dark:text-white hover:text-white l-light'>NexusNest</h2>
