...
export default function AddPrices({didSubmit}) {
                                ...
                                <form onSubmit={handleForm}>
                                    <div className="grid grid-cols-1">
                                        <div className="mb-5">
                                            ...
                                            <input name="productid" id="productid" type="text" className="form-input w-full py-2 px-3 h-10 bg-transparent border border-inherit dark:border-gray-800 dark:bg-slate-900 dark:text-slate-200 rounded outline-none focus:border-violet-600/50 dark:focus:border-violet-600/50 focus:ring-0"
